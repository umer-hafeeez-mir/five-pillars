        ...
        {active !== "zakat" ? (
          ...
          <>
            ...
            <div className="mt-6 space-y-4">
              ...
              {/* Spacer so form does not hide behind the fixed tray */}
            ...
            <div className="fixed left-0 right-0 bottom-0 z-50">
              ...
              <div className="px-3 pb-4">
                <div className="max-w-md mx-auto space-y-3">
                  ...
                  <button className="w-full rounded-xl bg-brand-800 hover:bg-brand-900 text-white py-4 font-medium soft-shadow">
                    Calculate Zakat
                  </button>
