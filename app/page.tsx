          ...
          <>
            ...
            {showSummary ? (
              ...
              <div className="mt-6 max-w-3xl mx-auto space-y-4">
                ...
                {/* (Rest of power user cards unchanged) */}
                {/* ... your existing Cash, Metals, Other, Deductions, Accordion blocks remain the same ... */}
                ...
                {/* ✅ POWER USERS bottom buttons: 3 in a single row */}
                <BottomBar cols={3}>
                  <button
                    type="button"
              ...
              /* ================= GUIDED FLOW ================= */
              <div className="mt-6 max-w-3xl mx-auto space-y-4">
                {/* Your guided steps remain unchanged... */}

                {/* ✅ GUIDED bottom buttons: 2 buttons */}
                <BottomBar cols={2}>
                  <button
                    type="button"
                    onClick={handleShare}
